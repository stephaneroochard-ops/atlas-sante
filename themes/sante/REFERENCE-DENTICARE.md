# Référence visuelle — Denticare Everest / Green Home

Cette référence sert uniquement à guider la composition et les interactions visuelles. Aucun texte, logo, photographie, code ou asset de la référence ne sera repris.

## Principes à adapter

La page combine une barre supérieure d’informations pratiques, une navigation principale horizontale et un hero très aéré à forte dominante vert médical. Le titre éditorial est massif, le CTA est contrasté et les sections sont séparées par des courbes fluides.
